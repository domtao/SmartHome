...
import com.zunder.smart.custom.view.ViewPager.OnPageChangeListener;
	...
	private void addTextTab(final int position, final String title) {
		...
		tab.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				final AlertViewWindow alertViewWindow=new AlertViewWindow(MainActivity.getInstance(), MainActivity.getInstance().getString(R.string.fast_control), ListNumBer.getControl(),null,0);
				alertViewWindow.setAlertViewOnCListener(new AlertViewWindow.AlertViewOnCListener() {
					...
					public void onItem(int pos, String itemName) {
						...
						sendCMD.sendCMD(0, itemName, null);
