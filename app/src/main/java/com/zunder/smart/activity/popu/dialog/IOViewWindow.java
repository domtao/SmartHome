...
import com.zunder.smart.dao.impl.factory.DeviceIoFactory;
...
public class IOViewWindow implements OnClickListener{

	private Activity activity;
	private PopupWindow popupWindow;
	View pupView;
	private List<DeviceIo> list;
	...
	TextView back;
	private int ioCount;
	public IOViewWindow(Activity activity, String name,int _ioCount,int _selection) {
		super();
		this.activity=activity;
		this.ioCount=_ioCount;
		this.list= DeviceIoFactory.getDeviceIos(ioCount);
		if(_selection>=0) {
	...
	private void init(String name) {
		...
		wheel_camera.setItems(DeviceIoFactory.getDeviceIoNames(ioCount));
