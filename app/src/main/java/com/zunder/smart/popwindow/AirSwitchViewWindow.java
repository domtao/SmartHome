...
public class AirSwitchViewWindow implements OnClickListener{
	...
	TextView showTxt;
	TextView back;
	public AirSwitchViewWindow(Activity activity, String name, List<String> _list, String msg, int _selection) {
		super();
