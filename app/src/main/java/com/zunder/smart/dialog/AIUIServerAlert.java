...
//ȷ����ʾ��
public class AIUIServerAlert extends Dialog implements OnClickListener, DownListener {
	...
	public AIUIServerAlert(Activity context) {
	...
	public void down() {
		...
		String result = ISocketCode.setUpdateApk("AIUIService",
