...
public class InfraVersionAdapter extends BaseAdapter {

	List<InfraVersion> list;
	int mSelect = -1;
	Activity context;

	public InfraVersionAdapter(Activity context, List<InfraVersion> list) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewCach.but_text.setText(list.get(position).getVersionName());
