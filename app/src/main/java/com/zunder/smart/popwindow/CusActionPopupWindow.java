...
public class CusActionPopupWindow implements OnClickListener {
	...
	public CusActionPopupWindow(Activity context, String name,
			String deviceType, int typeId, int deviceId, int actionShow,
			int functionShow, int actionPramShow, int functionParamShow) {
		super();
