...
public class ProjectorVersionAdapter extends BaseAdapter {

	List<ProjectorVersion> list;
	int mSelect = -1;
	Activity activity;

	public ProjectorVersionAdapter(Activity context, List<ProjectorVersion> list) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewCach.imageName.setText(list.get(position).getVersionName());
