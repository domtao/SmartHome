...
public class RoomImageAdapter extends SwipeMenuAdapter<RoomImageAdapter.DefaultViewHolder> {
	static List<ImageNet> list;
	static int mSelect = -1;
	static Activity activity;

	public RoomImageAdapter(Activity activity, List<ImageNet> list) {
	...
	@Override
	public RoomImageAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
		return new RoomImageAdapter.DefaultViewHolder(realContentView);
	}
	@Override
	public void onBindViewHolder(RoomImageAdapter.DefaultViewHolder holder, int position) {
