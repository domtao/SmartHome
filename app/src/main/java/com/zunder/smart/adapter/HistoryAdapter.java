...
public class HistoryAdapter extends BaseAdapter {
	...
	public HistoryAdapter(Activity context, List<History> list) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewCach.userName = (TextView) convertView
		...
		viewCach.userName.setText(context.getString(R.string.optionuser)+list.get(position).getUserName());
		return convertView;
	}
