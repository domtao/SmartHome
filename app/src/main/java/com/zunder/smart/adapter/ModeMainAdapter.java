...
public class ModeMainAdapter extends SwipeMenuAdapter<ModeMainAdapter.DefaultViewHolder> {
	static	List<Mode> list;
	static int mSelect = -1;
	static Activity activity;

	public ModeMainAdapter(Activity activity, List<Mode> list) {
	...
	@Override
	public ModeMainAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
		return new ModeMainAdapter.DefaultViewHolder(realContentView);
	}
	@Override
	public void onBindViewHolder(ModeMainAdapter.DefaultViewHolder holder, int position) {
