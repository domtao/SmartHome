...
public class TtsService {
 private   static TtsService install;
   private  Activity activity;
    ...
    public static synchronized TtsService getInstance() {
        if (install == null) {
            install = new TtsService();
        }
        return install;
    }
    public void setInit(Activity _activity,String text) {
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
        ...
        if (code != ErrorCode.SUCCESS) {
            if (code == ErrorCode.ERROR_COMPONENT_NOT_INSTALLED) {
                ...
                ToastUtils.ShowError(activity, "语音合成失败,错误码: " + code, Toast.LENGTH_SHORT, true);
            }
        }
    }
