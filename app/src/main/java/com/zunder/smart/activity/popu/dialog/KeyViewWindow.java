...
public class KeyViewWindow implements OnClickListener{

	private Activity activity;
	private PopupWindow popupWindow;
	View pupView;
	private List<InfraCode> list;
	...
	TextView showTxt;
	TextView back;
	public KeyViewWindow(Activity activity, String name, List<InfraCode> list, int selection) {
		super();
