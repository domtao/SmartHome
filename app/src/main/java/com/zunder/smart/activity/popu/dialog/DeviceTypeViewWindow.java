...
public class DeviceTypeViewWindow implements OnClickListener{
	...
	TextView showTxt;
	TextView back;
	public DeviceTypeViewWindow(Activity activity, String name, int _selection) {
		super();
		this.activity=activity;
		this.list= DeviceTypeFactory.getInstance().getDeviceTypes(1);
		if(_selection>=0) {
	...
	private void init(String name) {
		...
		wheel_camera.setItems(DeviceTypeFactory.getInstance().getDeviceTypeNames(1));
