...
public class ArceSpinerPopWindow extends PopupWindow implements OnItemClickListener{

	private Context mContext;
	private ListView mListView;
	private ArceSpinerAdapter mAdapter;
	private ArceSpinerAdapter.IOnItemSelectListener mItemSelectListener;
	
	
	public ArceSpinerPopWindow(Context context)
	{
		super(context);
	...
	public void setAdatper(ArceSpinerAdapter adapter){
		mAdapter = adapter;
	...
	public <T> void refreshData(List<Room> list, int selIndex)
	{
