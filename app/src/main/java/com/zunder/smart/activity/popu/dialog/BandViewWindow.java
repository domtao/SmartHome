...
public class BandViewWindow implements OnClickListener{

	private Activity activity;
	private PopupWindow popupWindow;
	View pupView;
	private List<InfraName> list;
	...
	TextView showTxt;
	TextView back;
	public BandViewWindow(Activity activity, String name, List<InfraName> list,int selection) {
		super();
...
public List<String> getString(){
	List<String> result=new ArrayList <String>();
		for (int i=0;i<list.size();i++){
			result.add(list.get(i).getInfraName());
		}
		return result;
}
