...
public class ProcaseImageAdapter extends SwipeMenuAdapter<ProcaseImageAdapter.DefaultViewHolder> {
	static List<ImageNet> list;
	static int mSelect = -1;
	static Activity activity;

	public ProcaseImageAdapter(Activity activity, List<ImageNet> list) {
	...
	@Override
	public ProcaseImageAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
		return new ProcaseImageAdapter.DefaultViewHolder(realContentView);
	}
	@Override
	public void onBindViewHolder(ProcaseImageAdapter.DefaultViewHolder holder, int position) {
