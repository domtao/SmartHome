...
public class GateWayAdapter extends SwipeMenuAdapter<GateWayAdapter.DefaultViewHolder> {
	...
	public GateWayAdapter(Activity context,List<GateWay> list,
						  Map<String, String> map) {
		 this.context=context;
		GateWayAdapter.list = list;
		GateWayAdapter.map = map;
	}

	public void getPosstion(int pos) {
		if (GateWayAdapter.pos != pos) {
			GateWayAdapter.pos = pos;
		}
	...
	@Override
	public GateWayAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
		return new GateWayAdapter.DefaultViewHolder(realContentView);
	}
	@Override
	public void onBindViewHolder(GateWayAdapter.DefaultViewHolder holder, int position) {
