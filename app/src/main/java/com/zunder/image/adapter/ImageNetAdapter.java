...
public class ImageNetAdapter extends SwipeMenuAdapter<ImageNetAdapter.DefaultViewHolder> {
	static List<ImageNet> list;
	static int mSelect = -1;
	static Activity activity;

	public ImageNetAdapter(Activity activity, List<ImageNet> list) {
	...
	@Override
	public ImageNetAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
		return new ImageNetAdapter.DefaultViewHolder(realContentView);
	}
	@Override
	public void onBindViewHolder(ImageNetAdapter.DefaultViewHolder holder, int position) {
