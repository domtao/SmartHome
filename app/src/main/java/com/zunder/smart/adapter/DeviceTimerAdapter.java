...
public class DeviceTimerAdapter extends SwipeMenuAdapter<DeviceTimerAdapter.DefaultViewHolder> {

	public static Boolean isSearch = false;
	static List<DeviceTimer> list;

	public DeviceTimerAdapter(	List<DeviceTimer> list) {
		this.list = list;
	...
	@Override
	public DeviceTimerAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
		return new DeviceTimerAdapter.DefaultViewHolder(realContentView);
	}
	@Override
	public void onBindViewHolder(DeviceTimerAdapter.DefaultViewHolder holder, int position) {
